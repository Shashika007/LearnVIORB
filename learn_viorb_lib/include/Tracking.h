...
public:
    ...
    Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Map* pMap,
             ...
             ConfigParam* pParams, IFrameSubscriber *sub, IMapPublisher *pub , bool bReuseMap=false);
#else
    Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Map* pMap,
             KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor,
             ConfigParam* pParams, IFrameSubscriber *sub, IMapPublisher *pub);
#endif	 
    ...
    cv::Mat GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const std::vector<IMUData> &vimu,const double &timestamp);
    cv::Mat GrabImageMonocular(const cv::Mat &im, const double &timestamp);

    void SetLocalMapper(LocalMapping* pLocalMapper);
    void SetLoopClosing(LoopClosing* pLoopClosing);
    void SetViewer(Viewer* pViewer);
    void SetFrameSubscriber(IFrameSubscriber* sub){mpFrameSubscriber = sub;}
    void SetMapPublisher(IMapPublisher* pub){mpMapPublisher = pub;}
