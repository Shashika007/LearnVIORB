...
Frame::Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timeStamp, const std::vector<IMUData> &vimu,
...
Frame::Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp, const std::vector<IMUData> &vimu,
...
// -- > map load function -------- frame :: remove later 
