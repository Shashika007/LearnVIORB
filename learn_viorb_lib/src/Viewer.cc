...
Viewer::Viewer(System* pSystem, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Tracking *pTracking, const string &strSettingPath, bool mbReuseMap_):
    ...
    mbFinishRequested(false), mbFinished(true), mbStopped(false), mbStopRequested(false), mbReuseMap(mbReuseMap_)
#else
...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuRemove_map("menu.Remove_map",false,false);
