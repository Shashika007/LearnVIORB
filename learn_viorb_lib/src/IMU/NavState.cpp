...
void NavState::serialize(Archive &ar, const unsigned int version)
{
     ar & _P;
     ar & _V;
     ar & _R;
...
template void NavState::serialize(boost::archive::binary_iarchive&, const unsigned int);
template void NavState::serialize(boost::archive::binary_oarchive&, const unsigned int);
#endif
