...
ConfigParam::ConfigParam(std::string configfile,int sys_type)
{
    ...
    if(sys_type == 0){
        ...
        fSettings["imutopic"] >> _imuTopic;
        fSettings["imagetopic0"]>>_imageTopic0;
        fSettings["imagetopic1"]>>_imageTopic1;
        std::cout<<"imu topic: "<<_imuTopic<<std::endl;
        std::cout<<"image left topic: "<<_imageTopic0<<std::endl;
        std::cout<<"image right topic: "<<_imageTopic1<<std::endl;
    }else{
        fSettings["imutopic"] >> _imuTopic;
        fSettings["imagetopic"]>>_imageRGBTopic;
        fSettings["depthtopic"]>>_depthTopic;
        std::cout<<"imu topic: "<<_imuTopic<<std::endl;
        std::cout<<"image topic: "<<_imageRGBTopic<<std::endl;
