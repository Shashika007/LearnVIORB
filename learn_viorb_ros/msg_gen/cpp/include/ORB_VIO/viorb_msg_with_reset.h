...
struct viorb_msg_
{
  ...
  _GetNumTrack_type GetNumTrack;
   ...
   typedef  ::std_msgs::Bool_<ContainerAllocator>  _ResetTracker_type;
  _ResetTracker_type ResetTracker;
...
struct MD5Sum< ::ORB_VIO::viorb_msg_<ContainerAllocator> >
{
  ...
  {
    return "bb5a8c05e0db2c5ed200e3ca0b1a80bc";
  }

  static const char* value(const ::ORB_VIO::viorb_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbb5a8c05e0db2c5eULL;
  static const uint64_t static_value2 = 0xd200e3ca0b1a80bcULL;
};
...
struct Printer< ::ORB_VIO::viorb_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ORB_VIO::viorb_msg_<ContainerAllocator>& v)
  {
    ...
    s << indent << "ResetTracker: ";
    s << std::endl;
    Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, indent + "  ", v.ResetTracker);
  }
};
