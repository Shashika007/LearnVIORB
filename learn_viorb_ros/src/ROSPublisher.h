...
class ROS_System: public ORB_SLAM2::System::GenericBuilder{
public:
#ifdef FUNC_MAP_SAVE_LOAD  
    ROS_System(const std::string& strVocFile,
    ...
    virtual ORB_SLAM2::IMapPublisher* GetMPublisher() override;
    virtual ORB_SLAM2::IFrameSubscriber* GetSubscriber() override;
